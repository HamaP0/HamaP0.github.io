...
*   **원인: 단일 실패 지점(Single Point of Failure)에 대한 의존**
   ...
   위 세 가지 문제의 공통적인 원인은 인증 과정을 여러 겹으로 보호하는 심층 방어 전략 없이 단 하나의 방어선(주로 비밀번호)에만 의존했기 때문입니다. 비밀번호 추측을 막는 장치(Part 1) · 인증 상태를 지키는 장치(Part 2) · 비상시를 위한 복구 절차(Part 3)가 모두 허술했습니다.
...
**분석 대상:** DVWA - Brute Force (인증 시도 공격에 대한 방어)
